...
from transformers.generation_utils import BeamHypotheses, calc_banned_ngram_tokens, calc_banned_bad_words_ids, \
...
class AMRBartModel(bart.PretrainedBartModel):
    ...
    def forward(
        ...
        encoder_outputs: Tuple = self._filter_out_falsey_values(encoder_outputs)
    ...
    def _filter_out_falsey_values(self, tup) -> Tuple:
